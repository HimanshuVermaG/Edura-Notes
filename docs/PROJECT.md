...
> **Note (legacy/simplified spec):** This document describes an older variant of the app (email/password auth only, no Google OAuth, no Community/Score Calculator/Admin/public routes, no pagination). For the current application behavior and stack, see [README.md](README.md).
